...
export const createTextInput = (props: TextInputProps): HTMLInputElement => {
  ...
  input.className = 'flex-1 h-[38px] border border-green-400 rounded-lg px-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-600 disabled:opacity-50 disabled:cursor-not-allowed'
  return input
}
